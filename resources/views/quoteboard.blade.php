<div id="swup" class="maincontainer">
    <div class="navcontainer">
        ...
        <div id="swup" class="navcontainer__flexcontainer navcontainer__flexcontainer--right transition-out_right">
            <a href="/board={{ $boardId }}/quizmode" class="navcontainer__quizbuttoncontainer">
    ...
    <div id="swup" class="transition-content">
        ...
        <section class="filtercontainer">
            <x-filterbutton filtertype="favourite" :href="request()->is('board=*/favorieten') ? url('/board=' . $boardId) : url('/board=' . $boardId . '/favorieten')">Favorieten</x-filterbutton>
