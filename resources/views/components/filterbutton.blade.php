...
@if ($filtertype == 'favourite')
    <div class="filtercontainer__section">
        <a {{ request()->is('board/favorieten') ? 'href=/board' : 'href=/board/favorieten' }}>
            <div class="filtercontainer__section__button button" style="background-color: {{ request()->is('board/favorieten') ? '#FEE440' : '' }};" > 
...
@elseif ($filtertype == 'button')
    ...
    <div class="filtercontainer__section filtercontainer__section--addbutton">
        <button class="filtercontainer__section__button button" {{ $attributes }}> 
